...
public class CompanyController {
    ...
    @GetMapping("/company/rndGreaterThan/{value}")
    public List<Company> getCompaniesByRndGreaterThan(@PathVariable double value) {
        return companyService.getCompaniesByRndGreaterThan(value);
    }
    ...
    @GetMapping("/company/rnd/{rnd}")
    public List<Company> getCompaniesByRnd(@PathVariable double rnd) {
        return companyService.getCompaniesByRnd(rnd);
    }
