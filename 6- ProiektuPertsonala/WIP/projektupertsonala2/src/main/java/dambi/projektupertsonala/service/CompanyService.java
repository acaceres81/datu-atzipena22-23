...
public class CompanyService {
    ...
    public List<Company> getCompaniesWithSalesGreaterThan(double salesValue){
        return companyRepository.findBySalesGreaterThan(salesValue);
    }

    public List<Company> getCompaniesWithRndGreaterThan(double rndValue){
        return companyRepository.findByRndGreaterThan(rndValue);
    }
